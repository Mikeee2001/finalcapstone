                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card card-warning">
                                ...
                                <div class="card-body">
                                    <p>Update your personal information to keep your profile accurate and up-to-date.
                                    </p>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="confirmDeleteModalLabel">Confirm Account Deletion
                                        </h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-danger" id="confirmDeleteButton">Delete
                                            Account</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#changePasswordForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: '{{ route('admin.change-password') }}', // Your route for changing password
                    type: 'POST',
